...
require_once('/app/lib/_autoload.php');
...
if ( $bIsAuthenticated ) {
    ...
    echo <<<html
        ...
        <form id="logout" action="https://ssp.stepup.example.com/sp.php" method="get">
...
echo <<<html
        <h3>Login (again)</h3>
        <form id="login" action="https://ssp.stepup.example.com/sp.php" method="get">
html;
...
HTML_select('Request LOA: ', 'loa',
    array(
        "" => "None",
        "1.5" => "1.5 (self-asserted token LoA)",
        "1" => "1",
        "2" => "2",
        "3" => "3",
    ),
